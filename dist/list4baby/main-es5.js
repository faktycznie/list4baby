...
var AddComponent = /** @class */ (function () {
    function AddComponent(itemService, categoryService) {
    ...
    AddComponent.prototype.showMore = function () {
        this.moreStatus = !this.moreStatus;
    };
    AddComponent.prototype.onCatSelect = function (value) {
        this.cat = +value;
    };
...
var CategoriesComponent = /** @class */ (function () {
    function CategoriesComponent(location, differs, categoryService, messagesService) {
    ...
    CategoriesComponent.prototype.ngDoCheck = function () {
        var changes = this.catDiffer.diff(this.categories);
        if (changes) {
    ...
    CategoriesComponent.prototype.onEdit = function (category) {
    ...
    CategoriesComponent.prototype.goBack = function () {
        this.selectedCategory = null;
    };
...
var CatlistComponent = /** @class */ (function () {
    function CatlistComponent(categoryService) {
        this.categoryService = categoryService;
    ...
    CatlistComponent.prototype.onSelect = function (category) {
        if (!category) {
            category = true;
            this.selected = null;
        }
    ...
    CatlistComponent.ctorParameters = function () { return [
...
var ItemComponent = /** @class */ (function () {
    function ItemComponent(route, router, location, itemService, categoryService) {
        this.route = route;
        this.router = router;
        this.location = location;
        this.itemService = itemService;
    ...
    ItemComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (params) {
            ...
            _this.item = _this.itemService.getItem(id);
        });
    };
...
var ListComponent = /** @class */ (function () {
    function ListComponent(location, router, differs, itemService, categoryService, messagesService) {
        this.location = location;
        this.router = router;
        this.differs = differs;
        this.itemService = itemService;
    ...
    ListComponent.prototype.ngDoCheck = function () {
        var changes = this.itemsDiffer.diff(this.items);
        if (changes) {
            /* If you want to see details then use
            changes.forEachRemovedItem((record) => ...);
            changes.forEachAddedItem((record) => ...);
    ...
    ListComponent.prototype.getItems = function () {
        ...
        this.itemService.getItems()
            ...
            _this.items = items;
            _this.totalPrice = _this.itemService.getTotalPrice();
        });
    };
    ListComponent.prototype.onSelect = function (item) {
        this.selectedItem = item;
    };
    ListComponent.prototype.onFilter = function (category) {
        this.getItems();
        this.filter = null;
        this.messagesService.clear();
        if (typeof category === 'object') {
            this.filter = category.id;
            this.items = this.items.filter(function (i) { return i.cat === category.id; });
    ...
    ListComponent.prototype.onComplete = function (item) {
    ...
    ListComponent.prototype.onSearch = function (name) {
        this.router.navigate(["products/" + name]);
    };
    ListComponent.prototype.getName = function (id) {
        return this.categoryService.getName(id);
    };
    ListComponent.prototype.getColor = function (id) {
...
var MessagesComponent = /** @class */ (function () {
    ...
    MessagesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.messagesService.currentMessage.subscribe(function (message) { return _this.message = message; });
    };
...
var ProductsComponent = /** @class */ (function () {
    function ProductsComponent(route, router, productsService, messagesService) {
        this.route = route;
        this.router = router;
    ...
    ProductsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.paramMap.subscribe(function (params) {
            var page = (params.get('page')) ? +params.get('page') : null;
            var query = (params.get('query')) ? decodeURI(params.get('query')) : null;
            _this.getProducts(query, page);
        });
    };
    ProductsComponent.prototype.getProducts = function (query, page) {
        var _this = this;
        this.loader = true;
        ...
        this.products = null;
        this.messagesService.clear();
        this.productsService.getProducts(this.query, this.start).subscribe(function (data) {
            _this.setData(data);
        }, function (err) {
            if (err.status == 403) {
                _this.messagesService.send('API requests daily limit exceeded! ' + err.error.error.message, 'error');
            }
            else {
                _this.messagesService.send(err.message, 'error');
            }
        });
    };
...
var SettingsComponent = /** @class */ (function () {
    function SettingsComponent(cookieService, messagesService) {
    ...
    SettingsComponent.prototype.useSampleData = function () {
    ...
    SettingsComponent.prototype.removeData = function () {
        //TODO confirmation :)
...
var CategoryService = /** @class */ (function () {
    function CategoryService(cookieService, itemService) {
        this.cookieService = cookieService;
        this.itemService = itemService;
    }
    ...
    CategoryService.prototype.addSampleData = function () {
    ...
    CategoryService.prototype.removeCategory = function (category) {
        this.categories = this.categories.filter(function (i) { return i.id !== category.id; });
        this.saveCategories();
    ...
    CategoryService.prototype.editCategory = function (category) {
        var id = this.findIndex(category.id);
        this.categories[id] = category;
        this.saveCategories();
    };
    CategoryService.prototype.saveCategories = function () {
        localStorage.setItem('categories', JSON.stringify(this.categories));
    };
    CategoryService.prototype.findIndex = function (id) {
    ...
    CategoryService.prototype.getNewID = function () {
        return (this.categories.length) ? this.categories[this.categories.length - 1].id + 1 : 0;
    };
    CategoryService.prototype.getName = function (id) {
        var e_1, _a;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.categories), _c = _b.next(); !_c.done; _c = _b.next()) {
                var cat = _c.value;
                if (cat.id === id) {
                    return cat.name;
                }
    ...
    CategoryService.prototype.getColor = function (id) {
        var e_2, _a;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.categories), _c = _b.next(); !_c.done; _c = _b.next()) {
                var cat = _c.value;
...
var ItemService = /** @class */ (function () {
    function ItemService(cookieService) {
        this.cookieService = cookieService;
    ...
    ItemService.prototype.addSampleData = function () {
    ...
    ItemService.prototype.editItem = function (item) {
        var id = this.findIndex(item.id);
        this.items[id] = item; // ? testing
        this.saveItems();
    };
    ItemService.prototype.saveItems = function () {
        localStorage.setItem('items', JSON.stringify(this.items));
    };
    ItemService.prototype.findIndex = function (id) {
    ...
    ItemService.prototype.getNewID = function () {
    ...
    ItemService.prototype.getTotalPrice = function (items) {
        var e_1, _a;
        if (!items) {
            items = this.items;
        }
        ...
        try {
            for (var items_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](items), items_1_1 = items_1.next(); !items_1_1.done; items_1_1 = items_1.next()) {
                ...
                if (item.price && !item.completed) {
                    var q = (item.quantity) ? item.quantity : 1;
                    total += q * +item.price;
                }
            }
        }
...
var MessagesService = /** @class */ (function () {
    ...
    MessagesService.prototype.send = function (message, type, time) {
        var _this = this;
        var msg = {
            name: message
        };
...
var ProductsService = /** @class */ (function () {
    ...
    ProductsService.prototype.getProducts = function (query, page) {
        var url = this.api;
        url += "&key=" + this.key;
